...
[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=pantos-io_client-library&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=pantos-io_client-library)
